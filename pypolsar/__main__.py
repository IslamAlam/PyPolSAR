...
from pypolsar import __version__
from pypolsar.example import hello
...
app = typer.Typer(
    name="pypolsar",
    help="PyPolSAR is a python module for Polarimetric Synthetic Aperture Radar (PolSAR) data processing.",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]pypolsar[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
